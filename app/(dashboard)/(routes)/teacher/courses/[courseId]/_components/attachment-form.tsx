        ...
        {!isEditing  && (
            <>
                {initialData.attachments.length === 0 && (
                    <p className='texxt-sm mt-2 text-slate-500 italic'>
                        No attachments yet
                    </p>
                )}
                    ...
                    <div className="space-y-2">
                        {initialData.attachments.map((attachment)=>(
                            ...
                            >
                                ...
                                {deletingId !== attachment.id &&(
                                    <button
                                    className='ml-auto hover:opacity-75 trasnsition'
         ...
         {isEditing && (
            <div>
                ...
                <div className='text-xs text-muted-foreground mt-4'>
                    Add anyhting your students might need to complete your course
                </div>
            </div>
         )}
    </div>  
